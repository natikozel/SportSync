...
import NewTrainer from "./components/Trainer/NewTrainer";
import TraineesList from "./components/Trainer/TraineesList";
import TraineeDetails from "./components/Trainer/TraineeDetails";
import ReviewsList from "./components/Trainer/ReviewsList";
import PendingRequests from "./components/Trainer/PendingRequests";
import AcceptedRequests from "./components/Trainer/AcceptedRequests";
import RequestDetail from "./components/Trainer/RequestDetail";
import EditTrainerDetails from "./components/Trainer/EditTrainerDetails";
